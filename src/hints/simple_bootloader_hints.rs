...
pub fn simulate_keccak_fill_mem_with_state(
    ...
    let mut full_num = (0..8).try_fold(BigUint::from(0u32), |acc, i| {
...
///     rule=signature_rule_wrapper(verify_ecdsa_sig, vm_ecdsa_additional_data),
/// )
...
/// Implements
/// (ids.r, ids.s) = vm_ecdsa_additional_data[ids.start]
