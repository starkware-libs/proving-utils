...
use super::types::SubtaskHashFunc;
...
pub fn validate_hash(
    ...
    let computed_program_hash = compute_program_hash_chain(&program, 0, SubtaskHashFunc::Pedersen)
        .map_err(|e| {
...
pub fn program_hash_function_to_ap(
    ...
    let program_hash_function: SubtaskHashFunc = exec_scopes.get(vars::PROGRAM_HASH_FUNCTION)?;
