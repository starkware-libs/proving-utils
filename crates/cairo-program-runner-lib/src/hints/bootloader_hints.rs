...
mod tests {
    ...
    fn make_references(num: i32) -> HashMap<usize, HintReference> {
    ...
    fn make_ids_data(names: &[&str]) -> std::collections::HashMap<String, HintReference> {
        let references = make_references(names.len() as i32);
    ...
    fn test_prepare_simple_bootloader_output_segment(bootloader_input: BootloaderInput) {
        ...
        let ids_data = make_ids_data(&["simple_bootloader_output_start"]);
