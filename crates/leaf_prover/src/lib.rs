...
use crate::consts::{
    DISABLED_COMPONENTS, DISABLED_COMPONENTS_SMALL_PREPROCESSED,
};

/// Describes the structure of the output JSON file
#[serde_as]
#[derive(Serialize, Deserialize, Debug, PartialEq)]
pub struct LeafProverSerializedOutput {
...
pub fn prove_leaf(
    ...
    let program_output = output_buffer
        ...
        .collect::<Vec<_>>();
    let n_outputs = program_output.len();
    ...
    let circuit_preprocessed_root = circuit_proof.stark_proof.proof.commitments
