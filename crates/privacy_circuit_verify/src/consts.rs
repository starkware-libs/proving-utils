...
pub const CIRCUIT_OUTPUT_ADDRESSES: [usize; 4] = [237958, 237959, 2095809, 2095810];
pub const CIRCUIT_N_BLAKE_GATES: usize = 9822;
pub const PRIVACY_CAIRO_VERIFIER_CONSTS_HASH: [u32; 8] = [
    1782435706, 1146442523, 1453552794, 1861796161, 1474245494, 472365775, 724358908, 884725714,
];
pub const PRIVACY_RECURSION_CIRCUIT_PREPROCESSED_ROOT: [u32; 8] = [
    91081818, 1140515838, 799078478, 484626822, 1697339551, 1849315443, 1468224199, 1172922119,
];
