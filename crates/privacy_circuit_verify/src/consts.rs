...
pub const CAIRO_PROOF_UNCOMPRESSED_BYTES: usize = 627_016;

/// Uncompressed size in bytes of the serialized recursive circuit proof.
pub const RECURSIVE_PROOF_UNCOMPRESSED_BYTES: usize = 263_808;
...
pub const PRIVACY_RECURSION_CIRCUIT_PREPROCESSED_ROOT: [u32; 8] = [
    887308193, 687212415, 614133892, 200195650, 306816545, 169616805, 1068958056, 540356120,
];
