...
pub const RECURSIVE_PROOF_UNCOMPRESSED_BYTES: usize = 344_506;
...
pub const PRIVACY_RECURSION_CIRCUIT_PREPROCESSED_ROOT: [u32; 8] = [
    691843233, 371030257, 1763738592, 588978679, 1324588795, 1302299535, 2092829065, 97049248,
];
...
pub const PRIVACY_CIRCUIT_PREPROCESSED_IDS: [&str; 61] = [
    "blake_sigma_0",
    "blake_sigma_1",
    "blake_sigma_2",
    "blake_sigma_3",
