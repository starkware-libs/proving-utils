...
pub const CIRCUIT_OUTPUT_ADDRESSES: [usize; 4] = [228459, 228460, 2020009, 2020010];
pub const CIRCUIT_N_BLAKE_GATES: usize = 9421;
pub const PRIVACY_CAIRO_VERIFIER_CONSTS_HASH: [u32; 8] = [
    42186467, 1107510990, 683983545, 1579933463, 2133107670, 951524861, 112569646, 1033135744,
];
pub const PRIVACY_RECURSION_CIRCUIT_PREPROCESSED_ROOT: [u32; 8] = [
    71295039, 362076857, 2083529325, 252222442, 1521872754, 1791108355, 2147372500, 1569300351,
];
