...
pub const CIRCUIT_OUTPUT_ADDRESSES: [usize; 4] = [220402, 220403, 1980514, 1980515];
...
pub const PRIVACY_RECURSION_CIRCUIT_PREPROCESSED_ROOT: [u32; 8] = [
    1993657766, 1463582238, 1401339664, 335134388, 1610131718, 155839239, 1851069628, 686579596,
];
