...
use crate::consts::{
    ...
    LIFTING_LOG_SIZE, NUM_OUTPUTS, PRIVACY_BOOTLOADER_PATH, PRIVACY_CAIRO_VERIFIER_CONSTS_HASH,
...
pub fn verify_cairo(proof_output: &PrivacyProofOutput) -> Result<Context<QM31>, Box<dyn Error>> {
...
pub fn get_circuit_config() -> CircuitConfig {
    CircuitConfig {
...
pub fn get_preprocessed_circuit(
