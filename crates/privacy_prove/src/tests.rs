...
pub mod slow_tests {
    ...
    use privacy_circuit_verify::{verify_privacy_bootloader, verify_privacy_circuit};
    ...
    fn test_privacy_prove_and_verify() {
        ...
        verify_privacy_bootloader(&proof_output).unwrap();
    }
    ...
    fn test_privacy_recursive_prove_and_verify() {
        ...
        verify_privacy_circuit(&proof_output).unwrap();
    }
}
